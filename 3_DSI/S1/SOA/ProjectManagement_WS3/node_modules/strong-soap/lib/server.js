  ...
  _process(input, req, callback) {
    ...
    try {
      if (binding.style === 'rpc') {
        operationName = Object.keys(body)[0] === (self.wsdl.options.attributesKey || 'attributes') ? Object.keys(body)[1] : Object.keys(body)[0];
        ...
        //document style
        var messageElemName = Object.keys(body)[0] === (self.wsdl.options.attributesKey || 'attributes') ? Object.keys(body)[1] : Object.keys(body)[0];
  ...
  _executeMethod(options, req, callback) {
    ...
    function handleResult(error, result) {
      ...
      var message = envelope.body.toString({
        pretty: self.wsdl.options.prettyResponse
      });
