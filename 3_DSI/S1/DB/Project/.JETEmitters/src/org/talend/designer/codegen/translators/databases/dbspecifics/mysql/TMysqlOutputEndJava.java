...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_132 = NL + "\t        }" + NL + "\t        try{" + NL + "\t        \tint processedCount_";
  protected final String TEXT_133 = " = pstmt_";
  protected final String TEXT_134 = ".executeUpdate();" + NL + "\t        \tinsertedCount_";
  protected final String TEXT_135 = " += processedCount_";
  protected final String TEXT_136 = ";" + NL + "\t        \trowsToCommitCount_";
  protected final String TEXT_137 = ";" + NL + "\t        }catch(java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_138 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t        \t";
  ...
  protected final String TEXT_142 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_143 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_144 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_146 = ": pstmt_";
  protected final String TEXT_147 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_148 = " += (countEach_";
  protected final String TEXT_149 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_150 = " += countSum_";
  protected final String TEXT_151 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_152 = NL + "\t            \t    \t";
  protected final String TEXT_153 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_154 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_155 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                    globalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "                \t";
  protected final String TEXT_156 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_157 = NL + "                \tint countSum_";
  protected final String TEXT_158 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_159 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_160 = " < 0 ? 0 : countEach_";
  protected final String TEXT_161 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_162 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_163 = NL + "            \t    insertedCount_";
  protected final String TEXT_164 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_165 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_166 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_167 = NL + "    \t\t";
  protected final String TEXT_168 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_169 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_170 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_171 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_172 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_173 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_174 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_175 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_176 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_177 = "\");" + NL + "        }";
  protected final String TEXT_178 = NL + "\t";
  protected final String TEXT_179 = NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_180 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_181 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_183 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_184 = ");" + NL + "\t\t\t}" + NL + "\t\t\trowsToCommitCount_";
  protected final String TEXT_185 = ";" + NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t    \t";
  protected final String TEXT_187 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_188 = ";" + NL + "\t    \t";
  protected final String TEXT_189 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_190 = NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "globalMap.put(\"";
  protected final String TEXT_191 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "    \t";
  protected final String TEXT_192 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_193 = NL + "    \tint countSum_";
  protected final String TEXT_194 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_195 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_196 = ");" + NL + "\t\t}" + NL + "\t\trowsToCommitCount_";
  protected final String TEXT_197 = ";" + NL + "\t\t";
  protected final String TEXT_198 = NL + "    \tupdatedCount_";
  protected final String TEXT_199 = ";" + NL + "    \t";
  protected final String TEXT_200 = NL + "    \tdeletedCount_";
  protected final String TEXT_201 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_202 = NL + "\t}";
  protected final String TEXT_203 = NL + NL + "        if(pstmt_";
  protected final String TEXT_204 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_206 = ".close();" + NL + "\t\t\t\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_207 = "\");" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_209 = ");" + NL + "\t\t\t";
  protected final String TEXT_210 = NL + "        }";
  protected final String TEXT_211 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_212 = "\", true);";
  protected final String TEXT_213 = NL + "    \tif (commitCounter_";
  protected final String TEXT_214 = " > 0 && rowsToCommitCount_";
  protected final String TEXT_215 = " != 0) {" + NL + "    \t\t";
  protected final String TEXT_216 = NL + "    \t}" + NL + "    \tconn_";
  protected final String TEXT_217 = ".commit();" + NL + "    \tif (commitCounter_";
  protected final String TEXT_218 = NL + "\t\t\trowsToCommitCount_";
  protected final String TEXT_219 = " = 0;" + NL + "    \t}" + NL + "\t\tcommitCounter_";
  ...
  protected final String TEXT_224 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_225 = "\", true);" + NL + "    \t";
  protected final String TEXT_226 = NL + "\tnb_line_deleted_";
  protected final String TEXT_227 = "=nb_line_deleted_";
  protected final String TEXT_228 = "+ deletedCount_";
  protected final String TEXT_229 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_230 = "=nb_line_update_";
  protected final String TEXT_231 = " + updatedCount_";
  protected final String TEXT_232 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_233 = "=nb_line_inserted_";
  protected final String TEXT_234 = " + insertedCount_";
  protected final String TEXT_235 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_236 = "=nb_line_rejected_";
  protected final String TEXT_237 = " + rejectedCount_";
  protected final String TEXT_238 = ";" + NL + "\t";
  protected final String TEXT_239 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_240 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_241 = "_NB_LINE\",nb_line_";
  protected final String TEXT_242 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_243 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_244 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_245 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_246 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_247 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_248 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_249 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_250 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_251 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_252 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_253 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_254 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_255 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_256 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_257 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_258 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_259 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_260 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_261 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_265 = "_NB_LINE_REJECTED\", nb_line_rejected_";
