...
package projet1.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_PROJET1_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJET1_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET1_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend/PROJET1/temp/preview/directors.csv"))
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/directors.txt";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"projet1/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 45852 characters generated by Talend Open Studio for Data Integration on the
 * November 16, 2024 at 9:40:49 AM CET
 ************************************************************************************************/