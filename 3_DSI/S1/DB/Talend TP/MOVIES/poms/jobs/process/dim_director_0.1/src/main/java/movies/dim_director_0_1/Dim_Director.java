...
package movies.dim_director_0_1;
 ...
 * @status
 */
public class Dim_Director implements TalendJob {
	...
	private final String jobName = "Dim_Director";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Director.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_MOVIES_Dim_Director = new byte[0];
		static byte[] commonByteArray_MOVIES_Dim_Director = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MOVIES_Dim_Director.length) {
					if (length < 1024 && commonByteArray_MOVIES_Dim_Director.length == 0) {
						commonByteArray_MOVIES_Dim_Director = new byte[1024];
					} else {
						commonByteArray_MOVIES_Dim_Director = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MOVIES_Dim_Director, 0, length);
				strReturn = new String(commonByteArray_MOVIES_Dim_Director, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MOVIES_Dim_Director, 0, length);
				strReturn = new String(commonByteArray_MOVIES_Dim_Director, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MOVIES_Dim_Director) {
	...
	public static class DirectorStruct implements routines.system.IPersistableRow<DirectorStruct> {
		final static byte[] commonByteArrayLock_MOVIES_Dim_Director = new byte[0];
		static byte[] commonByteArray_MOVIES_Dim_Director = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final DirectorStruct other = (DirectorStruct) obj;
		...
		public void copyDataTo(DirectorStruct other) {
		...
		public void copyKeysDataTo(DirectorStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(DirectorStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				DirectorStruct Director = new DirectorStruct();
				DirectorStruct row4 = Director;
				...
				String tableName_tDBOutput_1 = "Directors";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Udp+eK78PZ3wSp6dLvDlDxRkOngAgEgvYpXyCQ==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("Directors")) {
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "Directors" + "` WHERE `id` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "Directors" + "` (`id`,`name`) VALUES (?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "Directors" + "` SET `name` = ? WHERE `id` = ?";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Director");
				}
...
// # Outputs initialization
				DirectorStruct Director_tmp = new DirectorStruct();
// ###############################
						...
						if (row1 != null) {
							...
							row1.titleType.equals("movie")
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.nconst = row2.directors;
...
// # Output table : 'Director'
									Director_tmp.id = row1.tconst;
									Director_tmp.name = row3.primaryName;
...
///////////////////////		
									...
									if (Director.id != null) { //
										row_tLogRow_1[0] = String.valueOf(Director.id);

									} //

									if (Director.name != null) { //
										row_tLogRow_1[1] = String.valueOf(Director.name);
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Director");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row3,row2) outputs:(Director)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_3 = /** Start field tFileInputDelimited_3:FILENAME */
						"C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/IMDB_DataSet/title.crew.tsv"/**
																										 * End field
						...
						try {
							...
							if (rowtFileInputDelimited_3.length == 1 && ("\015").equals(rowtFileInputDelimited_3[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									row2.tconst = rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3];
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									row2.directors = rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3];
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									row2.writers = rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3];
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final Dim_Director Dim_DirectorClass = new Dim_Director();

		int exitCode = Dim_DirectorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Director.class.getClassLoader()
					.getResourceAsStream("movies/dim_director_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Director.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Director");
		}
...
/************************************************************************************************
 * 154580 characters generated by Talend Open Studio for Data Integration on the
 * November 30, 2024 at 3:28:21 AM CET
 ************************************************************************************************/