		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/LHOR1+oyVxE7Dk9p/3EJwOWwAENwT1Qu8kAMA==");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`id` VARCHAR(9)  ,`year` INT(4)  ,primary key(`id`))");
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "Date" + "` WHERE `id` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "Date" + "` (`id`,`year`) VALUES (?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "Date" + "` SET `year` = ? WHERE `id` = ?";
				...
				util_tLogRow_1.addRow(new String[] { "id", "year", });
...
// # Filter conditions 
									...
									!row1.startYear.equals("\\N")

									) {
										Date_tmp.id = row1.tconst;
										Date_tmp.year = row1.startYear;
										Date = Date_tmp;
...
// Start of branch "Date"
								if (Date != null) {
									...
									try {
										...
										row2.id = TypeConvert.String2String(Date.id);
									} catch (java.lang.Exception e) {
									...
									try {
										...
										row2.year = TypeConvert.String2Integer(Date.year);
									} catch (java.lang.Exception e) {
										globalMap.put("tConvertType_1_ERROR_MESSAGE", e.getMessage());
										bHasError_tConvertType_1 = true;
										throw e;
...
/************************************************************************************************
 * 95980 characters generated by Talend Open Studio for Data Integration on the
 * November 30, 2024 at 12:06:36 PM CET
 ************************************************************************************************/