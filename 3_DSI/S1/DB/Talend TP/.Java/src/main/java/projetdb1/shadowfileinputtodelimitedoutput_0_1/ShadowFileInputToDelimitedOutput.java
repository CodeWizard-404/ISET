...
package projetdb1.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	private final String projectName = "PROJETDB1";
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_PROJETDB1_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJETDB1_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETDB1_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/PROJETDB1/temp/preview/TMDB+IMDB movies_processed.csv"))
				...
				String[] headColutFileOutputDelimited = new String[21];
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[21];
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"projetdb1/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 68476 characters generated by Talend Open Studio for Data Integration on the
 * November 27, 2024 at 9:41:48 PM CET
 ************************************************************************************************/