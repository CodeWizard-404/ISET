...
package projetdb.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	private final String projectName = "PROJETDB";
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_PROJETDB_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_PROJETDB_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETDB_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/PROJETDB/temp/preview/TMDB+IMDB movies_processed.csv"))
				...
				String[] headColutFileOutputDelimited = new String[1];
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/TMDB+IMDB movies_processed.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/TMDB+IMDB movies_processed.csv",
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[1];
					...
					if (!((Object) ("C:/Users/Kayto/Desktop/IT/CODE/ISET/3_DSI/S1/DB/Talend TP/TMDB+IMDB movies_processed.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"projetdb/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 45363 characters generated by Talend Open Studio for Data Integration on the
 * November 27, 2024 at 9:18:03 PM CET
 ************************************************************************************************/